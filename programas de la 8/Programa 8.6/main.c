...
/* Esta función se utiliza para manejar las ventas a un cliente. Se ingresan productos y cantidades, el fin de datos está dado por el cero. Además de obtener el total de las ventas, se actualiza el inventario. */
{
    int CLA, CAN, I, RES;
    float TOT, PAR;
...
/* Esta función se utiliza para reabastecer el inventario. */
{
    int CLA, CAN, I;
    printf("\nIngrese clave del producto - 0 para salir: ");
    scanf("%d", &CLA);
