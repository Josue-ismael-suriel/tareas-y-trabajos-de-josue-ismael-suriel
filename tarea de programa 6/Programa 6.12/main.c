...
void Lectura(float[][MES][AÑO], int, int, int);
void Funcion1(float[][MES][AÑO], int, int, int);
void Funcion2(float[][MES][AÑO], int, int, int);
void Funcion3(float[][MES][AÑO], int, int, int);
